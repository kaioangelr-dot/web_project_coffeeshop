...
Triple Espresso is a project with core features, including iframes and forms. It's designed to be a comfortable and welcoming website related to a coffee shop, which allows users to book tables, check the coffee shop's schedule, and contact the staff, as well as engage with social media channels.
...
This feature allows us to add other websites to our own website. I decided to add cooking recipes from YouTube.

### Forms

Here, the customer can sign up and book a table in the coffee shop. I limited the number of guests per booking.
